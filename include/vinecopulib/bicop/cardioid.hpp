...
//! @brief The cardioid circula.
//!
//! This class is used in the implementation underlying the Bicop class.
//! Users should not use AbstractBicop or derived classes directly, but
//! always work with the Bicop interface.
//!
//! The binding density is the cardioid
//! \f$ g(\theta) = (1 + 2\rho\cos\theta) / 2\pi \f$ with concentration
//! \f$ \rho \in [0, 1/2] \f$.
//!
//! @literature
...
class CardioidBicop : public BindingBicop
{
public:
  CardioidBicop();
...
#include <vinecopulib/bicop/implementation/cardioid.ipp>
