...
{
  auto controls = FitControlsBicop();
  EXPECT_ANY_THROW(controls.set_num_threads(0));
  ...
  EXPECT_ANY_THROW(controls.set_rotations({ 0, 90, 180, 270, 360 }));
  EXPECT_ANY_THROW(controls.set_rotations({ 0, 90, 180, 270, 270 }));
}
