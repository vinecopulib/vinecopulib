...
The A\+IC is defined as \[ \mathrm{AIC} = -2\, \mathrm{loglik} + 2 p, \] where $ \mathrm{loglik} $ is the log-\/liklihood and $ p $ is the (effective) number of parameters of the model, see \hyperlink{classvinecopulib_1_1_bicop_ad1ee397f2273ed07ba1d5d2ebff7ef1f}{loglik()} and \hyperlink{classvinecopulib_1_1_bicop_a6fbc58e9d4cd565e805347083cbcc63d}{calculate\+\_\+npars()}. The A\+IC is a consistent model selection criterion for nonparametric models.
...
The B\+IC is defined as \[ \mathrm{BIC} = -2\, \mathrm{loglik} + \ln(n) p, \] where $ \mathrm{loglik} $ is the log-\/liklihood and $ p $ is the (effective) number of parameters of the model, see \hyperlink{classvinecopulib_1_1_bicop_ad1ee397f2273ed07ba1d5d2ebff7ef1f}{loglik()} and \hyperlink{classvinecopulib_1_1_bicop_a6fbc58e9d4cd565e805347083cbcc63d}{calculate\+\_\+npars()}. The B\+IC is a consistent model selection criterion for nonparametric models.
...
The log-\/likelihood is defined as \[ \mathrm{loglik} = \sum_{i = 1}^n \ln c(U_{1, i}, U_{2, i}), \] where $ c $ is the copula density \hyperlink{classvinecopulib_1_1_bicop_a0ee385fbc68736ebc6ddd52188686108}{pdf()}.
...
The function calls \hyperlink{classvinecopulib_1_1_bicop_a2d509a8b404a73ef17f04a0678e90a71}{fit()} for all families in {\ttfamily family\+\_\+set}) and selects the best fitting model by either B\+IC or A\+IC, see \hyperlink{classvinecopulib_1_1_bicop_a5935f84a33d80dbe7cbc6d071a1e8d75}{bic()} and \hyperlink{classvinecopulib_1_1_bicop_afa2b49c6c6da183f8cb365981d4d559c}{aic()}.
...
\item[{const Eigen\+::\+Matrix\+Xd \&}]{parameters}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classvinecopulib_1_1_bicop_ac8d1d4266b0fd7e2f971d0149f881ef9}{}\label{classvinecopulib_1_1_bicop_ac8d1d4266b0fd7e2f971d0149f881ef9}
...
\item[{int}]{rotation}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\hypertarget{classvinecopulib_1_1_bicop_a4e359624560a089273b25dc74879bd16}{}\label{classvinecopulib_1_1_bicop_a4e359624560a089273b25dc74879bd16}
