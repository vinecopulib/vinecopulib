...
namespace vinecopulib
{
    ...
    //!     optimization.
    //! @return A pointer to an object that inherits from \c Bicop.
    BicopPtr AbstractBicop::select(Eigen::Matrix<double, Eigen::Dynamic, 2> data,
    ...
    Eigen::VectorXd AbstractBicop::pdf(const Eigen::Matrix<double, Eigen::Dynamic, 2>& u)
    {
    ...
    //! @{
    Eigen::VectorXd AbstractBicop::hfunc1(const Eigen::Matrix<double, Eigen::Dynamic, 2>& u)
    {
        switch (rotation_) {
            case 0:
    ...
    Eigen::VectorXd AbstractBicop::hfunc2(const Eigen::Matrix<double, Eigen::Dynamic, 2>& u)
    {
        switch (rotation_) {
            case 0:
                return hfunc2_default(cut_and_rotate(u));
    ...
    Eigen::VectorXd AbstractBicop::hinv1(const Eigen::Matrix<double, Eigen::Dynamic, 2>& u)
    {
        switch (rotation_) {
            case 0:
    ...
    Eigen::VectorXd AbstractBicop::hinv2(const Eigen::Matrix<double, Eigen::Dynamic, 2>& u)
    {
        switch (rotation_) {
            case 0:
                return hinv2_default(cut_and_rotate(u));
    ...
    Eigen::Matrix<double, Eigen::Dynamic, 2> AbstractBicop::simulate(const int& n)
    {
    ...
    //! @{
    double AbstractBicop::loglik(const Eigen::Matrix<double, Eigen::Dynamic, 2>& u)
    {
    ...
    double AbstractBicop::aic(const Eigen::Matrix<double, Eigen::Dynamic, 2>& u)
    {
        return -2 * this->loglik(u) + 2 * calculate_npars();
    }

    double AbstractBicop::bic(const Eigen::Matrix<double, Eigen::Dynamic, 2>& u)
    {
        return -2 * this->loglik(u) + this->calculate_npars() * log(u.rows());
    }
    //! @}

    Eigen::MatrixXd AbstractBicop::tau_to_parameters(const double& tau)
    {
