...
\begin{center}
\leavevmode
\includegraphics[width=212pt]{classvinecopulib_1_1_clayton_bicop__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=212pt]{classvinecopulib_1_1_clayton_bicop__coll__graph}
\end{center}
\end{figure}
...
\item 
vinecopulib/include/vinecopulib/bicop/clayton.\+hpp\item 
vinecopulib/src/bicop/clayton.\+cpp\end{DoxyCompactItemize}
