...
namespace rosenbrock_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "bin/rosenbrock.stan");
    reader.add_event(9, 9, "end", "bin/rosenbrock.stan");
    return reader;
}

class rosenbrock : public prob_grad {
private:
public:
    rosenbrock(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "rosenbrock_namespace::rosenbrock";
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "rosenbrock_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef rosenbrock_namespace::rosenbrock stan_model;
