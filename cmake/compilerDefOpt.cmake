if(NOT WIN32)
    ...
    if(STRICT_COMPILER AND CMAKE_CXX_COMPILER_ID MATCHES "GNU")
      set(CMAKE_CXX_FLAGS                "${CMAKE_CXX_FLAGS} -Werror -Wno-delete-non-virtual-dtor -Wall -Wextra -Wconversion")
        ...
        set(CMAKE_CXX_FLAGS                "${CMAKE_CXX_FLAGS} -Wextra -Wall -Wno-delete-non-virtual-dtor -Werror=return-type")
    endif()
