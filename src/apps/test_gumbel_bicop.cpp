...
int main(int __unused argc, char __unused *argv[]) {
    ...
    b.set_rotation(180);
    std::cout << "The same gumbel copula rotated 180 degrees...\n";
    std::cout << "Family : " << b.get_family() << "\n";
    std::cout << "Parameter : " << b.get_parameters() << "\n";
    std::cout << "Rotation : " << b.get_rotation() << "\n";
    std::cout << "Number of parameters : " << b.calculate_npars() << "\n \n";
    ...
    std::cout << "The same gumbel copula rotated 90 degrees...\n";
    std::cout << "Family : " << b.get_family() << "\n";
    std::cout << "Parameter : " << b.get_parameters() << "\n";
    std::cout << "Rotation : " << b.get_rotation() << "\n";
    std::cout << "Number of parameters : " << b.calculate_npars() << "\n \n";
    ...
    b.set_rotation(270);
    std::cout << "The same gumbel copula rotated 270 degrees...\n";
    std::cout << "Family : " << b.get_family() << "\n";
    std::cout << "Parameter : " << b.get_parameters() << "\n";
    std::cout << "Rotation : " << b.get_rotation() << "\n";
    std::cout << "Number of parameters : " << b.calculate_npars() << "\n \n";
