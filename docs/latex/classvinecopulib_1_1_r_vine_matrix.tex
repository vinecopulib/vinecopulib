...
\subsubsection[{\texorpdfstring{R\+Vine\+Matrix(const Eigen\+::\+Matrix\+Xi \&matrix)}{RVineMatrix(const Eigen::Matrix<size_t, Eigen::Dynamic, Eigen::Dynamic> &matrix)}}]{\setlength{\rightskip}{0pt plus 5cm}vinecopulib\+::\+R\+Vine\+Matrix\+::\+R\+Vine\+Matrix (
...
\subsubsection[{\texorpdfstring{construct\+\_\+d\+\_\+vine\+\_\+matrix(const Eigen\+::\+Vector\+Xi \&order)}{construct_d_vine_matrix(const Eigen::Matrix<size_t, Eigen::Dynamic, 1> &order)}}]{\setlength{\rightskip}{0pt plus 5cm}Eigen\+::\+Matrix\+Xi vinecopulib\+::\+R\+Vine\+Matrix\+::construct\+\_\+d\+\_\+vine\+\_\+matrix (
\begin{DoxyParamCaption}
