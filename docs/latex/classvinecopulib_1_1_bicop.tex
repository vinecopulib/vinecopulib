...
\subsubsection[{\texorpdfstring{parameters\+\_\+to\+\_\+tau(const Eigen\+::\+Vector\+Xd \&parameters)}{parameters_to_tau(const Eigen::MatrixXd &parameters)}}]{\setlength{\rightskip}{0pt plus 5cm}double vinecopulib\+::\+Bicop\+::parameters\+\_\+to\+\_\+tau (
\begin{DoxyParamCaption}
