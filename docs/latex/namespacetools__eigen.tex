...
\hline
\end{DoxyParams}
\index{tools\+\_\+eigen@{tools\+\_\+eigen}!read\+\_\+matxs@{read\+\_\+matxs}}
\index{read\+\_\+matxs@{read\+\_\+matxs}!tools\+\_\+eigen@{tools\+\_\+eigen}}
\subsubsection[{\texorpdfstring{read\+\_\+matxs(const char $\ast$filename, int max\+\_\+buffer\+\_\+size)}{read_matxs(const char *filename, int max_buffer_size)}}]{\setlength{\rightskip}{0pt plus 5cm}Eigen\+::\+Matrix$<$ size\+\_\+t, Eigen\+::\+Dynamic, Eigen\+::\+Dynamic $>$ tools\+\_\+eigen\+::read\+\_\+matxs (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{filename, }
\item[{int}]{max\+\_\+buffer\+\_\+size}
\end{DoxyParamCaption}
)}\hypertarget{namespacetools__eigen_ab0621335fea3d0f9ebff30dd5bb1326d}{}\label{namespacetools__eigen_ab0621335fea3d0f9ebff30dd5bb1326d}
